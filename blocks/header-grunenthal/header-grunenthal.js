...
export default async function decorate(block) {
  ...
  // Build support bar from tools section
  const navTools = nav.querySelector('.nav-tools');
  const supportBar = document.createElement('div');
  supportBar.className = 'support-bar';
  if (navTools) {
    const supportBarInner = document.createElement('div');
    supportBarInner.className = 'support-bar-inner';
    supportBarInner.append(navTools);
    supportBar.append(supportBarInner);
  }

  const navWrapper = document.createElement('div');
  navWrapper.className = 'nav-wrapper';
  navWrapper.append(nav);
  block.append(supportBar);
